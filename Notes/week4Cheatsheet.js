...
//   //is the code to run if there is an error in the try
...
// }catch(error){
// //if error is and instance of reference than change it back to its orignal value
// if(error instanceof ReferenceError){
//   console.log("Reference error: reset a back to -2");
//   a = -2;
// }else{
//   console.log(error);
// }
...
//instanceof(true/false) ---> can be used for instances of errors
