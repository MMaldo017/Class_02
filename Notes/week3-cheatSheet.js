...
//   return null;
// }
// let myaray = [1,3,5,8,9]
// console.log(firstEven(myaray)); // 8
...
// }
// doTwice(() => console.log("Hello Martin")); // "Hi" "Hi"
// doTwice(() => console.log("This is another function"));
...
/* =========================
   ...
   - setInterval(fn, ms): run repeatedly until cleared ---> clearInterval
*/
...
// let consoleLog = () => console.log("This is an arrow function");
// consoleLog()
...
// const lowFilter = nums.filter(n => n <= 3);
// console.log(lowFilter);

// nums.forEach(n => console.log(n));
// let forEachArray = nums.forEach(n => console.log(n + 2.99));
// console.log(forEachArray);

// console.log(nums);

// 2) map: transform → new array
const doubled = nums.map(n => n + 1.50);
// console.log(doubled); // [12,8,6,4,10,2]
// console.log(nums);

// let filterM = stringArray.filter(n => n[0] === "m");
// console.log(filterM);

// let toCapsArray = stringArray.map(n => n.toLocaleUpperCase());
// console.log(toCapsArray);

// 3) filter: keep items that pass condition ---> creates a new Array as well
...
let stringArray = ["martin", "felix", "maldonado"];
stringArray.sort().reverse();
console.log(stringArray);

//compare function

const asc = [...nums].sort((a, b) => a - b);// [...nums] === [6,4,3,2,5,1] -> spread operator
